...
<div class="not-prose grid grid-cols-1 md:grid-cols-2 gap-6">
  ...
  <div class="rounded-2xl border bg-zinc-100 p-6">
    ...
    <p class="text-sm text-zinc-500 mt-3">Sẵn sàng: Thực tập/Part-time/Full-time</p>
    <p class="text-sm text-zinc-500 mt-3">Quan tâm: Front-end, AI engineer, Data Analyst</p>
  </div>
</div>
