...
<div class="not-prose page-shell navy-theme">
  <section class="page-hero">
    ...
    <div class="page-hero__content">
      ...
      <h1 class="page-title">Dự án & sản phẩm</h1>
    </div>
  </section>
    ...
    <div class="portfolio-grid">
      <article class="project-card">
        <div class="project-card__media">
          {{< img src="images/AnhDuAnRCM,Sentiment.png" alt="Recommender System + Sentiment Analysis" >}}
        </div>
      ...
      <article class="project-card">
        <div class="project-card__media">
          {{< img src="images/AnhDuAnAppMobileBanSach.png" alt="App Mobile Bán Sách" >}}
        </div>
        <div class="project-card__body">
      ...
      <article class="project-card">
        <div class="project-card__media">
          {{< img src="images/AnhDuAnBlogCaNhan.png" alt="Blog Cá Nhân" >}}
        </div>
        <div class="project-card__body">
